 ...
 */
final class Version20230211110745 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post (id INT NOT NULL, owner_id INT NOT NULL, text TEXT NOT NULL, PRIMARY KEY(id))');
